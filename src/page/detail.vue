  ...
  <div class="detail">
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="message">
          <span>{{channelNewData && channelNewData.time || '2019-12-17 12:00'}}</span>
          <span>{{channelNewData && channelNewData.src || 'lastest 40'}}</span>
        </div>
        <img :src="channelNewData && channelNewData.pic || require('../assets/logo.png')">
