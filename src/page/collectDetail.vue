  ...
  <div class="detail">
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="message">
          <span>{{$route.params.item && $route.params.item.time || '2019-12-17 12:00'}}</span>
          <span>{{$route.params.item && $route.params.item.src || 'lastest 40'}}</span>
        </div>
        <img :src="$route.params.item && $route.params.item.pic || require('../assets/logo.png')">
